...
class FastRandomTree
  ...
  protected de.embl.cba.classifiers.weka.FastRandomTree[] m_Successors;
  ...
  public void reassignAttributes( ArrayList< Integer > attributes )
  {
    ...
    {
      for ( de.embl.cba.classifiers.weka.FastRandomTree tree : m_Successors )
      {
 ...
 /**
  ...
  protected void buildTree(int[][] sortedIndices, int startAt, int endAt,
    ...
    if ( sensibleSplitFound ) {
      ...
      m_Successors = new de.embl.cba.classifiers.weka.FastRandomTree[dist.length];  // dist.length now always == 2
      for (int i = 0; i < dist.length; i++) {
        m_Successors[i] = new de.embl.cba.classifiers.weka.FastRandomTree();
  ...
  public static void main(String[] argv) {
    runClassifier(new de.embl.cba.classifiers.weka.FastRandomTree(), argv);
  }
