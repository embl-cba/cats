...
public class RunSylwiasWorkflowInternally
{
    ...
    public static void main(final String... args) throws Exception {
        ...
        parameters.clear();
        parameters.put( IOUtils.INPUT_IMAGE_FILE, new File( "/image-sequence/" + dataSetPattern ) );
        parameters.put( ApplyClassifierCommand.CLASSIFIER_FILE, new File( "/transmission-cells-3d.classifier" ) );
