...
@Plugin(type = Command.class, menuPath = "Plugins>Segmentation>CATS>Apply Classifier" )
public class ApplyClassifierCommand implements Command
{
	@Parameter
	...
	public void run()
	{
		...
		classifyImage( classifierFile, inputImageFile, outputDirectory );
	}
