...
import de.embl.cba.classifiers.weka.FastRfUtils;
...
public class DataCache
{
   ...
   * @param origData
   */
  public DataCache( de.embl.cba.classifiers.weka.DataCache origData ) {
   ...
   */
  public de.embl.cba.classifiers.weka.DataCache resample( int bagSize, Random random) {

    de.embl.cba.classifiers.weka.DataCache result =
            new de.embl.cba.classifiers.weka.DataCache(this); // makes shallow copy of vals matrix
   ...
   * constructor to see what's deep / shallow copied
   */
  public de.embl.cba.classifiers.weka.DataCache resampleBalancingLabels( int bagSizePercent,
																		 Map< Integer, ArrayList < Integer > >[] labelIds,
																		 Random random ) {

    de.embl.cba.classifiers.weka.DataCache dataCache = new de.embl.cba.classifiers.weka.DataCache(this ); // makes shallow copy of vals matrix
