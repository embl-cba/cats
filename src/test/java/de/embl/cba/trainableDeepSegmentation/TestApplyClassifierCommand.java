...
import static de.embl.cba.trainableDeepSegmentation.utils.IntervalUtils.getIntervalAsCsvString;
...
public class TestApplyClassifierCommand
{
    ...
    public static void main(final String... args) throws Exception {
        ...
        parameters.put( IOUtils.INPUT_IMAGE_FILE, new File( "/Users/tischer/Documents/fiji-plugin-deepSegmentation/src/test/resources/fib-sem--cell--8x8x8nm.zip" )  );
