...
public class FastRandomForest
  ...
  /** The bagger. */
  protected de.embl.cba.classifiers.weka.FastRfBagging m_bagger = null;
  ...
  public Capabilities getCapabilities(){
    return new de.embl.cba.classifiers.weka.FastRandomTree().getCapabilities();
  }
  ...
  public void buildClassifier(Instances data) throws Exception{
    ...
    m_bagger = new de.embl.cba.classifiers.weka.FastRfBagging();
    ...
    de.embl.cba.classifiers.weka.FastRandomTree rTree = new de.embl.cba.classifiers.weka.FastRandomTree();
  ...
  public static void main(String[] argv){
    runClassifier(new de.embl.cba.classifiers.weka.FastRandomForest(), argv);
  }
