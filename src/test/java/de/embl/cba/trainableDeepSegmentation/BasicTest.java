...
public class BasicTest
{
	...
	public void test1()
	{
		...
		DeepSegmentation segmentator = new DeepSegmentation( image );
	...
	private static ImagePlus segmentBridge(final ImagePlus bridge) {
		DeepSegmentation segmentator = new DeepSegmentation( bridge );
		segmentator.addExample( 0, new Roi( 10, 10, 50, 50 ), 1 , 1 );
		segmentator.addExample( 1, new Roi( 400, 400, 30, 30 ), 1, 1 );
